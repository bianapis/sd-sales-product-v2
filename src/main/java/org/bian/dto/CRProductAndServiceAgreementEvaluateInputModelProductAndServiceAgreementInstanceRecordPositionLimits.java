...
/**
 * CRProductAndServiceAgreementEvaluateInputModelProductAndServiceAgreementInstanceRecordPositionLimits
 */
public class CRProductAndServiceAgreementEvaluateInputModelProductAndServiceAgreementInstanceRecordPositionLimits   {
  ...
  /**
   * `status: Not Mapped`  core-data-type-reference: BIAN::DataTypesLibrary::CoreDataTypes::UNCEFACT::Text  general-info: The type of position maintained for the sales product (e.g. transaction credit/debit, netting, position) 
